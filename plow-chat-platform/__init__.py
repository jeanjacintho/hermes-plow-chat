...
_GROUP_SPEAK_RULE = (
    ...
    "in it until it turns elsewhere, and it turns elsewhere the moment someone "
    "addresses somebody else -- another agent, or a person by name. \"Hey Sam, do "
    "you know what this means?\" is Sam's to answer, even one line after you and "
    f"the asker were talking. Settle that question first, before you look anything up or use any "
